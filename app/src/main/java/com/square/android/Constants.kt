...
object SCREENS {
    ...
    const val SETTINGS_CREDENTIALS = "SETTINGS_CREDENTIALS"
    const val SETTINGS_CHANGE_PASSWORD = "SETTINGS_CHANGE_PASSWORD"
    const val SETTINGS_PUSH_NOTIFICATIONS = "SETTINGS_PUSH_NOTIFICATIONS"
...
object Network {
    ...
    // new for testing - http://square-app-new-api.herokuapp.com/api/
    const val BASE_API_URL = "http://square-app-new-api.herokuapp.com/api/"
